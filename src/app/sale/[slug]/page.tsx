...
const LISTING_META: Record<string, { title: string; description: string; image?: string }> = {
  ...
  "binghatti-aurora": {
    ...
    description: "1-bedroom apartment for sale in Binghatti Aurora, JVC Dubai. Modern finishes, fully fitted kitchen, pool and gym. Prime JVC investment opportunity. Contact Dulce Escobar.",
    image: "/aurora-4.jpg",
  },
  "binghatti-orchid": {
