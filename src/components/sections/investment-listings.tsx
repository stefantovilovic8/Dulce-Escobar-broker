...
export const LISTINGS_DATA = [
  ...
  },
  {
    ...
    images: [
      ...
      "/nakheel-villa-19.jpg",
      "/nakheel-villa-20.jpg",
    ],
  ...
  },
  {
    ...
    baths: 2,
    sqft: 921.18,
    statusKey: "listings.royale.status",
    typeKey: "listings.royale.type",
    priceKey: "listings.royale.price",
    pricePeriod: "Sale Price",
    furnishedKey: null as string | null,
    status: "for-sale",
    images: [
      ...
      "/binghatti-royale/royale-11.jpg",
      "/binghatti-royale/royale-12.jpg",
      "/binghatti-royale/royale-13.jpg",
      "/binghatti-royale/royale-14.jpg",
      "/binghatti-royale/royale-15.jpg",
      "/binghatti-royale/royale-16.jpg",
      "/binghatti-royale/royale-17.jpg",
      "/binghatti-royale/royale-18.jpg",
      "/binghatti-royale/royale-19.jpg",
      "/binghatti-royale/royale-20.jpg",
    ],
    description: "Presenting Binghatti Royale — an exceptional high-floor 1-bedroom apartment spanning an impressive 921.18 Sq. Ft. in the heart of Jumeirah Village Circle, Dubai. This is a rare opportunity to own a residence that defies expectations: a sprawling layout with two full bathrooms, a generous living and dining area, and a private balcony with panoramic road views. Every detail has been crafted for sophisticated living, from the premium finishes and floor-to-ceiling windows to the thoughtfully designed built-in wardrobes and fully fitted kitchen. As a resident of Binghatti Royale, you gain access to an elite suite of amenities: an infinity pool, kids' pool, state-of-the-art fitness centre, outdoor gym, paddle tennis court, landscaped gardens, multi-purpose lawn, kids' play area, 24/7 security with CCTV, and a dedicated parking space. Whether you're seeking a luxurious ready-to-move-in home or a prime investment opportunity in one of Dubai's fastest-growing communities, Binghatti Royale delivers uncompromising quality and exceptional value.",
    descriptionEs: "Presentamos Binghatti Royale — un excepcional apartamento de 1 dormitorio en planta alta con 921.18 pies² en el corazón de Jumeirah Village Circle, Dubái. Una oportunidad única de poseer una residencia que desafía las expectativas: distribución amplia con dos baños completos, amplia sala de estar y comedor, y balcón privado con vistas panorámicas a la carretera. Cada detalle ha sido diseñado para una vida sofisticada: acabados premium, ventanales de piso a techo, armarios empotrados y cocina totalmente equipada. Como residente de Binghatti Royale, accede a una suite de amenidades de élite: piscina infinita, piscina infantil, gimnasio de última generación, gimnasio al aire libre, pista de pádel, jardines paisajísticos, zona infantil, seguridad 24/7 con CCTV y estacionamiento dedicado. Ya sea que busque un hogar de lujo listo para mudarse o una oportunidad de inversión, Binghatti Royale ofrece calidad inigualable.",
    descriptionAr: "نقدم لكم بينغاتي رويال — شقة استثنائية من غرفة نوم واحدة في طابق مرتفع بمساحة 921.18 قدم مربع في قلب جميرة فيليدج سيركل، دبي. فرصة نادرة لامتلاك مسكن يفوق التوقعات: تصميم واسع مع حمامين كاملين، غرفة معيشة وتناول طعام واسعة، وشرفة خاصة مع إطلالات بانورامية على الطريق. تم تصميم كل التفاصيل للحياة الراقية: تشطيبات فاخرة، نوافذ ممتدة من الأرض حتى السقف، خزائن مدمجة، ومطبخ مجهز بالكامل. كمقيم في بينغاتي رويال، يمكنك الوصول إلى مجموعة راقية من المرافق: مسبح لامتناهي، مسبح أطفال، صالة رياضية متطورة، صالة رياضية خارجية، ملعب تنس، حدائق طبيعية، منطقة ألعاب أطفال، أمن على مدار الساعة مع كاميرات مراقبة، وموقف سيارات مخصص. سواء كنت تبحث عن منزل فاخر جاهز للانتقال أو فرصة استثمارية متميزة، فإن بينغاتي رويال تقدم جودة استثنائية.",
    salePrice: "1,750,000 AED",
  },
];
