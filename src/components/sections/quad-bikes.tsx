 ...
 */
export default function QuadBikes() {
  const { t } = useLanguage();
  ...
  const sectionAsset = "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/6363938c-1a0a-4fd7-80ff-6f78f509f220-we-concierge-com/assets/images/WhatsApp-Image-2025-03-03-at-9_20_05-AM-11.jpeg";
