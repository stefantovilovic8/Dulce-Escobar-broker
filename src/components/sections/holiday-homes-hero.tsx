...
const HolidayHomesHero = () => {
  const { t } = useLanguage();
  const heroImage = "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?q=80&w=2670&auto=format&fit=crop";
  ...
  return (
    <section className="relative w-full h-screen min-h-[700px] overflow-hidden">
      <img
        ...
        aria-hidden="true"
        fetchPriority="high"
        className="absolute inset-0 w-full h-full z-0 object-cover object-[center_45%]"
      />
...
export default HolidayHomesHero;