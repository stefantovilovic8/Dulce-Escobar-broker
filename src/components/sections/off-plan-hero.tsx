  ...
  return (
    <section className="relative w-full h-screen min-h-[700px] overflow-hidden">
      <img
        ...
        alt=""
        aria-hidden="true"
        className="absolute inset-0 w-full h-full z-0 object-cover object-[center_40%]"
      />
